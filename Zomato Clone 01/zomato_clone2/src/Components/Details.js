        ...
        return (
            <div>
                ...
                <div className="bodyDetail">
                    <div >
                        <img src={`./Img/${restaurant.image}`} alt="No , Sorry for the Inconvinience" width="100%" height="350" />
                ...
                <Modal
                    ...
                    style={customStyles} >
                    <div className="glyphicon glyphicon-remove" style={{ float: 'right', margin: '0px 0px 10px 0px' }} onClick={() => this.handleModal('galleryModelIsOpen', false)}></div>

                    <Carousel showThumbs={false} showStatus={false}>
                        {restaurant?.thumb?.map((item) => {
                            return (
                                <div>
                                    <img src={`./Img/${item}`} alt="No , Sorry for the Inconvinience" />
                                </div>
                            )
                        })}
                    </Carousel>
                                    ...
                                    <div className="card" style={{ width: '43rem', margin: 'auto' }}>
                                        <div className="row" style={{ paddingLeft: '10px', paddingBottom: '10px' }}>
                                            ...
                                            <div className="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                <img className="card-img-center title-img" src={`../${item.image}`} alt="No , Sorry for the Inconvinience" style={{
                                                    height: '75px',
                                                    width: '75px',
                                                    borderRadius: '20px',
                                                    marginTop: '12px',
